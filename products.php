...
<div class="container" style="margin-top:65px">
    ...
    <div class="row text-center" id="coffee">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/coffees.jpg" alt="" class="img-fluid pb-1" >
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/cal.jpg" alt="" class="img-fluid pb-1" >
                <div class="figure-caption">
                    <h6>Cafe Au Lait</h6>
                    <h6>Price :Rs 400</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/ddl.jpg" alt="" class="img-fluid pb-1" >
                <div class="figure-caption">
                    <h6>Dolce De Leche</h6>
                    <h6>Price :Rs 450</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/ic.jpg" alt="" class="img-fluid pb-1" >
                <div class="figure-caption">
                    <h6>Iced Coffee</h6>
                    <h6>Price :Rs 450</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
    ...
    <div class="row text-center" id="esp">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/cp.jpg" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
                    <h6>Con Panna</h6>
                    <h6>Price :Rs 400</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/m.jpg" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
                    <h6>Macchiato</h6>
                    <h6>Price :Rs 450</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/cap.jpg" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
                        <h6>Cappuccino</h6>
                        <h6>Price :Rs 500</h6>
                        <?php if (!isset($_SESSION['email'])) {?>
        ...
        <div class="row text-center" id="drinks" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/mcb.jpg" alt="" class="img-fluid pb-1" >
                        <div class="figure-caption">
                            <h6>Malited Cold Brew</h6>
                            <h6>Price :Rs 450</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/le.jpg" alt="" class="img-fluid pb-1" >
                        <div class="figure-caption">
                            <h6>Lemonade</h6>
                            <h6>Price :Rs 400</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/itea.jpg" alt="" class="img-fluid pb-1" >
                        <div class="figure-caption">
                            <h6>Iced Tea</h6>
                            <h6>Price :Rs 400</h6>
                            <?php if (!isset($_SESSION['email'])) {?>
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                        <img src="images/is.jpg" alt="" class="img-fluid pb-1" >
                        <div class="figure-caption">
                        <h6>Italian Soda</h6>
                    <h6>Price :Rs 450</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
            ...
            <div class="row text-center" id="food">
                    <div class="col-md-3 col-6 py-3" >
                        <div class="card">
                            <img src="images/cake.jpg" alt="" class="img-fluid pb-1" >
                            <div class="figure-caption">
                                <h6>Cake</h6>
                                <h6>Price :Rs 200</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/mafine.jpg" alt="" class="img-fluid pb-1" >
                            <div class="figure-caption">
                                <h6>Mafine</h6>
                                <h6>Price :Rs 180</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/cupcake.jpg" alt="" class="img-fluid pb-1" >
                            <div class="figure-caption">
                                <h6>Cup Cake</h6>
                                <h6>Price :Rs 150</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/lava.jpg" alt="" class="img-fluid pb-1" >
                            <div class="figure-caption">
                                <h6>Lava Cake</h6>
                                <h6>Price :Rs 250</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
